/* Pas de frame � d�clarer vu qu'on est d�j� extendsJFrame 
 * Donc si je fais un setTitle, alors c'est �quivalent � frame.setTitle, comme un this.seTitle
 * 
 * 
...
public class DemineurVersionFormateurModifie extends JFrame {
	// La grille de jeu
	private int[][] grille;
	...
	public DemineurVersionFormateurModifie(int largeur, int hauteur, int nombreBombes) {
	...
	private void factoryButton (int a, int b){
	...
	public static void main(String[] args) {
		DemineurVersionFormateurModifie demineur = new DemineurVersionFormateurModifie(20, 20, 5);
